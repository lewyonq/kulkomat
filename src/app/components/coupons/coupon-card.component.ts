      ...
      <div class="icon-section" [style.background]="coupon.iconGradient">
        ...
        @if (coupon.iconName === 'ticket') {
          <svg class="coupon-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3 8C3 7.44772 3.44772 7 4 7H20C20.5523 7 21 7.44772 21 8V10C19.8954 10 19 10.8954 19 12C19 13.1046 19.8954 14 21 14V16C21 16.5523 20.5523 17 20 17H4C3.44772 17 3 16.5523 3 16V14C4.10457 14 5 13.1046 5 12C5 10.8954 4.10457 10 3 10V8Z"
                  stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M9 7V17" stroke="white" stroke-width="2" stroke-linecap="round" stroke-dasharray="2 2"/>
          </svg>
        }
        ...
        @if (coupon.iconName === 'coins') {
          <svg class="coupon-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M15 7C17.7614 7 20 9.23858 20 12C20 14.7614 17.7614 17 15 17"
